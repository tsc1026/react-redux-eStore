...
import { PageHero } from '../components' //顯示幕前頁面路徑用
import aboutImg from '../assets/hero-bcg.jpeg'

const AboutPage = () => {
  return <main>
    <PageHero title='about'/> {/*title 塞在props內傳給 pageHero 顯示路徑用 */}
    <Wrapper className='page section section-center'>{/* css 在 global index.css */}
